...
echo "Creating '${EIP_DB_USER_ERPNEXT}' user and '${EIP_DB_NAME_ERPNEXT}' management database..."
create_eip_client_user_and_database "${EIP_DB_NAME_ERPNEXT:-}" "${EIP_DB_USER_ERPNEXT:-}" "${EIP_DB_PASSWORD_ERPNEXT:-}";
