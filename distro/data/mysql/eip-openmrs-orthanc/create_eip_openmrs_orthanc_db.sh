...
echo "Creating '${EIP_DB_USER_ORTHANC}' user and '${EIP_DB_NAME_ORTHANC}' database..."
create_eip_client_user_and_database ${EIP_DB_NAME_ORTHANC:-} ${EIP_DB_USER_ORTHANC:-} ${EIP_DB_PASSWORD_ORTHANC:-};
