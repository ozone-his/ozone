...
echo "Creating '${EIP_HCW_DB_USER}' user and '${EIP_HCW_DB_NAME}' database..."
create_eip_client_user_and_database ${EIP_HCW_DB_NAME:-} ${EIP_HCW_DB_USER:-} ${EIP_HCW_DB_PASSWORD:-};
